...
ERRORS = {
    ...
    "FACE_API_REQUEST_FAILED": (
        400,
        "人脸识别服务拒绝请求",
        "人脸识别服务拒绝了本次请求，请检查图片、活体或接口参数",
    ),
    "FACE_API_LOGIN_REJECTED": (
        403,
        "人脸识别未通过",
        "人脸识别服务没有返回认证成功，请重新识别",
    ),
    "FACE_API_ANTI_SPOOF_HIGH_RISK": (
        403,
        "疑似翻拍风险",
    ...
    "TERMINAL_EVENT_TIME_INVALID": (
        400,
        "终端识别时间无效",
        "终端识别时间不在允许窗口内，请检查终端时间并重新识别",
    ),
    "VALIDATION_ERROR": (
        422,
        "请求参数校验失败",
