...
- 文档已有分工：`README.md` 偏运行说明，`docs/04_usage/01_api_integration.md` 偏前端对接，`HOW_TO_DELIVER.md` 偏交付方式。
...
- `docs/04_usage/01_api_integration.md` 中的性能参考与 README 中 CPU/GPU 耗时表述不完全一致，需标记为“历史经验值，仅供参考”。
